    ...
    <GsapAnimation animation="fadeDown" :duration="1.2">
      <div class="relative">
        ...
        <div class="relative h-[600px] overflow-hidden">
          ...
          >
            ...
            >
              ...
              <!-- 文字内容 -->
              <div
                class="absolute inset-0 bg-black bg-opacity-30 flex items-center"
              >
        ...
        <GsapAnimation animation="fadeUp" :delay="0.5">
          <div
            class="absolute bottom-8 left-0 right-0 flex justify-center space-x-3"
          >
            <button
    ...
    <div class="container mx-auto px-4 py-[30px]">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="space-y-6">
            <div
              v-for="(item, index) in latestReports"
              :key="index"
              class="border-b border-gray-100 last:border-0 pb-4 last:pb-0"
            >
              <a href="#" class="block group">
                <h4
                  class="text-gray-900 group-hover:text-emerald-600 mb-2 line-clamp-2"
                >
                  {{ item.title }}
                </h4>
          ...
          <GsapAnimation animation="scale" :stagger="0.15">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              ...
              >
                ...
                <div class="p-4">
                  <h3
                    class="text-lg font-medium text-gray-900 group-hover:text-keri-blue transition-colors duration-200"
                  >
                    {{ photo.title }}
                  </h3>
...
const slides = [
  ...
  },
  {
    ...
    title: "글로벌 네트워크\n구축",
    description:
      "국내외 유수 연구기관들과의 교류를 통해 글로벌 싱크탱크로 성장하고 있습니다.",
  },
];
